...
<div>
    ...
    <div class="flexBox">
    <p class="kucukaciklamalar">Kaydol veya Devam et'e basarak <a class="hemenKaydol">kullanıcı sözleşmesi</a> ve <a class="hemenKaydol">gizlilik sözleşmesini</a> kabul etmiş sayılırsınız.</p>
    </div>
    ...
    <div class="footer-div">
        ...
        <div class="footersocial-div">
            <a href="https://facebook.com/bionluk" target="_blank" style="margin-right: 30px;">
                <img src="https://bionluk.azureedge.net/site/icon/tansel_footer_facebook_white.svg">
            </a> 
            <a href="https://twitter.com/bionluk" target="_blank" style="margin-right: 30px;">
                <img src="https://bionluk.azureedge.net/site/icon/tansel_footer_twitter_white.svg">
            </a> 
            <a  href="https://instagram.com/bionlukcom" target="_blank">
                <img src="https://bionluk.azureedge.net/site/icon/tansel_footer_instagram_white.svg">
            </a>
        </div>
    </div>
</div>
